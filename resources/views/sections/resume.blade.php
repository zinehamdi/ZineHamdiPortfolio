...
<section id="resume" class="py-12 lg:py-20" @if($rtl) dir="rtl" @endif aria-labelledby="resume-heading">
  <div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="bg-[#dbdbd7] p-6 sm:p-8 lg:p-12 rounded-2xl section-shadow transition-all duration-300">
          <header class="mb-8">
            <h2 id="resume-heading" class="text-[#1b1b18] uppercase font-black text-3xl sm:text-4xl mb-4">{{ $tr('resume.title','Resume') }}</h2>
          </header>
