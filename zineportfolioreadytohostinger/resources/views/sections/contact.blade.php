...
<section id="contact" class="py-16 lg:py-20" @if($rtl) dir="rtl" @endif aria-labelledby="contact-heading">
  <div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="bg-[#dbdbd7] p-6 sm:p-8 lg:p-12 rounded-2xl section-shadow transition-all duration-300">
          <header class="mb-8">
            <h2 id="contact-heading" class="text-[#1b1b18] uppercase font-black text-4xl mb-4">{{ $tr('contact.title','Contact') }}</h2>
            <p class="text-[#1b1b18]/80 text-xl mb-8">{{ $tr('contact.subtitle','Let’s build something together!') }}</p>
          </header>

          <p class="text-[#1b1b18]/80 text-lg leading-relaxed mb-8">
