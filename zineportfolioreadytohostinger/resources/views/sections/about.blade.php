...
<section id="about" class="py-16 lg:py-20" @if($rtl) dir="rtl" @endif aria-labelledby="about-heading">
  <div class="max-w-7xl mx-auto px-4 sm:px-6">
    <div class="bg-[#dbdbd7] p-6 sm:p-8 lg:p-12 rounded-2xl section-shadow transition-all duration-300">
          <header class="mb-6 lg:mb-8">
            <h2 id="about-heading" class="text-[#1b1b18] uppercase font-black text-2xl sm:text-3xl lg:text-4xl mb-4">{{ $tr('about.title','About Me') }}</h2>
            <p class="text-[#1b1b18]/80 text-lg sm:text-xl">{{ $tr('about.subtitle','I’m Hamdi Salem Zine — a full-stack developer, project manager, and digital builder') }}</p>
          </header>
          ...
          <!-- Metrics Grid -->
          <div class="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6 mb-6 lg:mb-8">
            @php $metrics = [
