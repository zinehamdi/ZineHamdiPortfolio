<div class="mt-16 bg-white">
  <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-10 grid gap-6 md:grid-cols-3 text-[#1b1b18]/90">
    <div>
      ...
      <div class="flex items-center gap-3 mb-3">
        ...
        <span class="font-semibold">Hamdi Salem Zine</span>
      </div>
  ...
  <div>
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-4 text-xs text-[#1b1b18]/60">&copy; {{ date('Y') }} Hamdi Salem Zine. {{ __('common.footer.rights') ?? 'All rights reserved.' }}</div>
  </div>
</div>
